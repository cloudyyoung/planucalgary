...
const theme: CustomFlowbiteTheme = {
  ...
  textInput: {
    "field": {
      ...
      "colors": {
        "gray": "border-none bg-container text-gray-900 focus:ring-2 focus:ring-primary-50 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:ring-primary-500",
