...
export const baseCommon = "rounded-full group relative flex items-center justify-center text-center font-medium transition-[color,background-color,border-color,text-decoration-color,fill,stroke,box-shadow,font-variation-settings] outline-none z-0"
export const stateLayerCommon = "after:rounded-full after:pointer-events-none after:absolute after:top-0 after:left-0 after:w-full after:h-full after:z-[-1] after:transition-[color,background-color,border-color,text-decoration-color,fill,stroke,box-shadow]"
